<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
          <el-table-column align="center" label="pk_order_id" v-if="show">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
            ...
            <el-form-item label="用户ID" prop="fkCustomerId">
              <el-input v-model="form.fkCustomerId" placeholder="请输入用户ID"></el-input>
            </el-form-item>
            <el-form-item label="订单类型   SW0601 线上  SW0602 线下" prop="orderType">
              <el-input v-model="form.orderType" placeholder="请输入订单类型   SW0601 线上  SW0602 线下"></el-input>
            </el-form-item>
            <el-form-item label="订单状态 SW0701 未付款 SW0702 已付款  SW0703 已收货 SW0704 已评价 SW0705 已完成 SW0706 已取消" prop="orderStatus">
              <el-input v-model="form.orderStatus" placeholder="请输入订单状态 SW0701 未付款 SW0702 已付款  SW0703 已收货 SW0704 已评价 SW0705 已完成 SW0706 已取消"></el-input>
            </el-form-item>
            <el-form-item label="售后状态 SW0801 未发起售后 SW0802 申请售后 SW0803 取消售后 SW0804 售后处理中 SW0805 处理完成" prop="afterStatus">
              <el-input v-model="form.afterStatus" placeholder="请输入售后状态 SW0801 未发起售后 SW0802 申请售后 SW0803 取消售后 SW0804 售后处理中 SW0805 处理完成"></el-input>
            </el-form-item>
            <el-form-item label="商品数量" prop="goodsCount">
              <el-input v-model="form.goodsCount" placeholder="请输入商品数量"></el-input>
            </el-form-item>
            <el-form-item label="订单总价" prop="orderAmount">
              <el-input v-model="form.orderAmount" placeholder="请输入订单总价"></el-input>
            </el-form-item>
            <el-form-item label="支付金额" prop="payAmount">
              <el-input v-model="form.payAmount" placeholder="请输入支付金额"></el-input>
            </el-form-item>
            <el-form-item label="最终金额" prop="totalAmount">
              <el-input v-model="form.totalAmount" placeholder="请输入最终金额"></el-input>
            </el-form-item>
            <el-form-item label="运费金额" prop="logisticsFee">
              <el-input v-model="form.logisticsFee" placeholder="请输入运费金额"></el-input>
            </el-form-item>
            <el-form-item label="收货地址" prop="fkAddressId">
              <el-input v-model="form.fkAddressId" placeholder="请输入收货地址"></el-input>
            </el-form-item>
            <el-form-item label="支付渠道 SW0901 余额 SW0902 微信 SW0903 支付宝 SW0904 银联" prop="payChannel">
              <el-input v-model="form.payChannel" placeholder="请输入支付渠道 SW0901 余额 SW0902 微信 SW0903 支付宝 SW0904 银联"></el-input>
            </el-form-item>
            <el-form-item label="订单支付单号" prop="tradeNo">
              <el-input v-model="form.tradeNo" placeholder="请输入订单支付单号"></el-input>
            </el-form-item>
            <el-form-item label="第三方支付流水" prop="escrowTradeNo">
              <el-input v-model="form.escrowTradeNo" placeholder="请输入第三方支付流水"></el-input>
            </el-form-item>
            <el-form-item label="支付时间" prop="payTime">
              <el-input v-model="form.payTime" placeholder="请输入支付时间"></el-input>
            </el-form-item>
            <el-form-item label="订单创建时间" prop="orderTime">
              <el-input v-model="form.orderTime" placeholder="请输入订单创建时间"></el-input>
            </el-form-item>
            <el-form-item label="发货时间" prop="deliveryTime">
              <el-input v-model="form.deliveryTime" placeholder="请输入发货时间"></el-input>
            </el-form-item>
            <el-form-item label="确认状态" prop="confirmStatus">
              <el-input v-model="form.confirmStatus" placeholder="请输入确认状态"></el-input>
            </el-form-item>
            <el-form-item label="收货时间" prop="receiveTime">
              <el-input v-model="form.receiveTime" placeholder="请输入收货时间"></el-input>
            </el-form-item>
            <el-form-item label="评论时间" prop="commentTime">
              <el-input v-model="form.commentTime" placeholder="请输入评论时间"></el-input>
            </el-form-item>
            <el-form-item label="订单结算状态 SW1101 未结算 SW1102 已结算" prop="settlementStatus">
              <el-input v-model="form.settlementStatus" placeholder="请输入订单结算状态 SW1101 未结算 SW1102 已结算"></el-input>
            </el-form-item>
            <el-form-item label="订单结算时间" prop="settlementTime">
              <el-input v-model="form.settlementTime" placeholder="请输入订单结算时间"></el-input>
            </el-form-item>
            <el-form-item label="优惠券" prop="fkCouponId">
              <el-input v-model="form.fkCouponId" placeholder="请输入优惠券"></el-input>
            </el-form-item>
            <el-form-item label="促销优化金额（促销价、满减、阶梯价）" prop="promotionAmount">
              <el-input v-model="form.promotionAmount" placeholder="请输入促销优化金额（促销价、满减、阶梯价）"></el-input>
            </el-form-item>
            <el-form-item label="积分抵扣金额" prop="integrationAmount">
              <el-input v-model="form.integrationAmount" placeholder="请输入积分抵扣金额"></el-input>
            </el-form-item>
            <el-form-item label="优惠券抵扣金额" prop="couponAmount">
              <el-input v-model="form.couponAmount" placeholder="请输入优惠券抵扣金额"></el-input>
            </el-form-item>
            <el-form-item label="管理员后台调整订单使用的折扣金额" prop="discountAmount">
              <el-input v-model="form.discountAmount" placeholder="请输入管理员后台调整订单使用的折扣金额"></el-input>
            </el-form-item>
            <el-form-item label="自动确认时间（天）" prop="autoConfirmDay">
              <el-input v-model="form.autoConfirmDay" placeholder="请输入自动确认时间（天）"></el-input>
            </el-form-item>
            <el-form-item label="可以获得的积分" prop="integration">
              <el-input v-model="form.integration" placeholder="请输入可以获得的积分"></el-input>
            </el-form-item>
            <el-form-item label="可以获得的成长值" prop="growth">
              <el-input v-model="form.growth" placeholder="请输入可以获得的成长值"></el-input>
            </el-form-item>
            <el-form-item label="活动信息" prop="promotionInfo">
              <el-input v-model="form.promotionInfo" placeholder="请输入活动信息"></el-input>
            </el-form-item>
            <el-form-item label="发票类型：0->不开发票；1->电子发票；2->纸质发票" prop="billType">
              <el-input v-model="form.billType" placeholder="请输入发票类型：0->不开发票；1->电子发票；2->纸质发票"></el-input>
            </el-form-item>
            <el-form-item label="发票抬头" prop="billHeader">
              <el-input v-model="form.billHeader" placeholder="请输入发票抬头"></el-input>
            </el-form-item>
            <el-form-item label="发票内容" prop="billContent">
              <el-input v-model="form.billContent" placeholder="请输入发票内容"></el-input>
            </el-form-item>
            <el-form-item label="收票人电话" prop="billReceiverPhone">
              <el-input v-model="form.billReceiverPhone" placeholder="请输入收票人电话"></el-input>
            </el-form-item>
            <el-form-item label="收票人邮箱" prop="billReceiverEmail">
              <el-input v-model="form.billReceiverEmail" placeholder="请输入收票人邮箱"></el-input>
            </el-form-item>
            <el-form-item label="是否积分产品" prop="isIntegral">
              <el-input v-model="form.isIntegral" placeholder="请输入是否积分产品"></el-input>
            </el-form-item>
            <el-form-item label="订单备注" prop="orderRemark">
              <el-input v-model="form.orderRemark" placeholder="请输入订单备注"></el-input>
            </el-form-item>
      </el-form>
