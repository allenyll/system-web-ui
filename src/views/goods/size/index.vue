<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="名称" v-model="listQuery.like_size_name"> </el-input>
      ...
      <el-button class="filter-item" v-if="sizeManager_btn_add" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="edit">添加</el-button>
    </div>
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
          <el-table-column align="center" label="pk_size_id" v-if="show">
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
            <el-form-item label="所在分组" prop="fkSizeGroupId">
              <el-select v-model="form.fkSizeGroupId" filterable placeholder="请选择">
                <el-option
                  v-for="item in sizeGroupIdOptions" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="名称" prop="sizeName">
              <el-input v-model="form.sizeName" placeholder="请输入名称"></el-input>
            </el-form-item>
            <el-form-item label="编码" prop="sizeCode">
              <el-input v-model="form.sizeCode" placeholder="请输入编码"></el-input>
            </el-form-item>
