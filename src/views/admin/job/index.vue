<template>
  <div class="app-container calendar-list-container">
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
          <el-table-column align="center" label="pk_job_id" v-if="show">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
            <el-form-item label="名称" prop="jobName">
              <el-input v-model="form.jobName" placeholder="请输入名称"></el-input>
            </el-form-item>
            <el-form-item label="调用方法名" prop="methodName">
              <el-input v-model="form.methodName" placeholder="请输入调用方法名"></el-input>
            </el-form-item>
            ...
            <el-form-item label="springBean" prop="springBean">
              <el-input v-model="form.springBean" placeholder="请输入springBean"></el-input>
            </el-form-item>
      </el-form>
